...
noAuthRouter.get("/latestprops",cache('5 minutes'), getLatestProps);
noAuthRouter.put("/reset", resetRatings);
noAuthRouter.get("/getallprops", cache('5 minutes'),getAllProperties);
noAuthRouter.get("/getbydist",cache('5 minutes'), getByDistrict);
